...
const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'ArgoCD', icon: icon('argocd') },
      { name: 'AWS', icon: icon('aws') },
      { name: 'Vault', icon: icon('vault') },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Elastic', icon: icon('elasticsearch') },
